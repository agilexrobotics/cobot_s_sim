  ...
  CLaserOdometry2D()
{
  ...
  while(!setLaserPoseFromTf())ros::spinOnce();
...
bool CLaserOdometry2DNode::setLaserPoseFromTf()
{
  ...
  ROS_WARN("laser2base = [x:%f y:%f z:%f yaw:%f]",
            laser_tf.translation()(0),
            laser_tf.translation()(1),
            laser_tf.translation()(2),
            rf2o::getYaw(laser_tf.rotation()));
