...
//service
ros::ServiceServer DelAllTraj_;

//subscriber
ros::Subscriber MoveJ_Cmd, MoveL_Cmd, MoveC_Cmd, JointPos_Cmd, Arm_DO_Cmd, Arm_AO_Cmd, Tool_DO_Cmd, Tool_AO_Cmd, Gripper_Cmd, Gripper_Set_Cmd, Emergency_Stop, Joint_En, IO_Update, sub_getArmStateTimerSwitch;
...
bool Del_All_Traj(void)
{
    ...
    //加入字符串对象
    cJSON_AddStringToObject(root, "command", "set_arm_delete_trajectory");
